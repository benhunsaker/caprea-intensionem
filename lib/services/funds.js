...
var Fund = function(){
  this.model = models.fund;
};

Fund.prototype.getAll = function(options, cb) {
  var body = {
    total: 0,
    results: []
  };
...
Fund.prototype.create = function (options, cb) {
  new this.model(options.body).save(cb);
};

Fund.prototype.get_by_id = function (options, cb) {
...
Fund.prototype.update = function (options, cb) {
...
Fund.prototype.delete = function (options, cb) {
