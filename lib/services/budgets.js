...
var Budget = function(){
  this.model = models.budget;
};

Budget.prototype.getAll = function(options, cb) {
  var body = {
    total: 0,
    results: []
  };
...
Budget.prototype.create = function (options, cb) {
  new this.model(options.body).save(cb);
};

Budget.prototype.get_by_id = function (options, cb) {
...
Budget.prototype.update = function (options, cb) {
...
Budget.prototype.delete = function (options, cb) {
